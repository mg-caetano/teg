...
\lstinputlisting[language=HTML,label=sniphtml,caption={Fragmento de código HTML \cite{HnC13}}]{snippets/snippet.html}
...
\lstinputlisting[label=snipcss,caption={Fragmento de código CSS \cite{Wp14}}]{snippets/snippet.css}
...
\lstinputlisting[language=HTML,label=snipjs,caption={Fragmento de código JavaScript \cite{JsTut}}]{snippets/snippetjs.html}
...
\lstinputlisting[language=XML,label=snipsvg,caption={Fragmento de código SVG \cite{Gra13}}]{snippets/snippet.svg}
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=0.6\textwidth]{fig21.png}
