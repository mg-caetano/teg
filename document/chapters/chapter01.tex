...
\begin{figure}[ht]
  ...
  \caption{Explicación del mecanismo de visualización History Flow. \cite[Fig. 2]{Vie04}}
  \label{fig1}
\end{figure}
...
\begin{figure}[ht]
  ...
  \caption{Codificación de palabras a color \cite[Fig. 1]{Wat07}}
  \label{fig6}
\end{figure}
...
\begin{figure}[ht]
  ...
  \caption{Creando un Cromograma \cite[Fig. 2]{Wat07}}
  \label{fig7}
\end{figure}
...
\begin{figure}[ht]
  ...
  \caption{Sistema WikiChanges mostrando la historia de revisiones para el artículo de Steve Fossett. \cite[Fig. 3]{Nun08}}
  \label{fig10}
\end{figure}
...
\begin{figure}[ht]
  ...
  \caption{Visualización Revert Graph del artículo de Charles Darwin \cite[Fig. 1]{Suh07}}
  \label{fig11}
\end{figure}
...
\begin{figure}[ht]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    ...
    \label{fig13}
  \end{subfigure}
  \caption{Visualizaciones de dos artículos tomados de la lista de accidentes de aviones comerciales de Wikipedia}
\end{figure}
...
\begin{figure}[ht]
  ...
  \caption{Metamodelo de History Graph y relación con una visualización \cite[Fig. 6]{Sca08}}
  \label{fig15}
\end{figure}
...
\begin{figure}[ht]
  ...
  \caption{Arquitectura del sistema WikiMetrics-UCV \cite[Fig. 3.1]{Dap12}}
  \label{fig16}
\end{figure}
