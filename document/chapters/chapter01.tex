...
\begin{figure}[ht]
  ...
  \caption{Explicación del mecanismo de visualización History Flow. \cite{Vie04}, Fig. 2}
  \label{fig1}
\end{figure}
...
\begin{figure}[ht]
  ...
  \caption{Codificación de palabras a color \cite{Wat07}, Fig. 1}
  \label{fig6}
\end{figure}
...
\begin{figure}[ht]
  ...
  \caption{Creando un Cromograma \cite{Wat07}, Fig. 2}
  \label{fig7}
\end{figure}
...
\begin{figure}[ht]
  ...
  \caption{Sistema WikiChanges mostrando la historia de revisiones para el artículo de Steve Fossett. \cite{Nun08}, Fig. 3}
  \label{fig10}
\end{figure}
...
\begin{figure}[ht]
  ...
  \caption{Visualización Revert Graph del artículo de Charles Darwin. \cite{Suh07}, Fig. 1}
  \label{fig11}
\end{figure}

\section{Estructuras y Dinámicas de las Colaboraciones en Wikipedia en Eventos Recientes}
Este trabajo estudia la dinámica de coordinación de los editores de Wikipedia sobre dos categorías de artículos: aquellos sobre eventos recientes y aquellos que son enciclopédicos \cite{Kee12}. Los resultados mostraron que las estructuras y dinámicas son distintas entre artículos para estas dos categorías y que tienen implicaciones en cómo los sistemas de inteligencia colectiva pueden apalancarse para procesar y dar sentido a información compleja.
...
\begin{figure}[ht]
  ...
  \caption{Arquitectura del sistema WikiMetrics-UCV \cite{Dap12}, Fig. 3.1}
  \label{fig16}
\end{figure}
