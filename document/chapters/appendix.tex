\begin{longtable}{ | P{5cm} | P{5cm} | P{5cm} |}
    ...
    \hline
    \multicolumn{1}{| c |}{\bfseries Nombre} &
    \multicolumn{1}{ c |}{\bfseries Variables de Datos} &
    \multicolumn{1}{ c |}{\bfseries Variables visuales} \\
    \hline
  \endfirsthead

  \multicolumn{3}{|c|}{\bfseries Comparación} \\
  \hline
  ...
  \hline
  \multicolumn{3}{|c|}{\bfseries Jerarquía, relación partes a todo} \\
  \hline
  ...
  \hline
  \multicolumn{3}{|c|}{\bfseries Cambios en el tiempo} \\
  \hline
  ...
  \hline
  \multicolumn{3}{|c|}{\bfseries Conexiones y relaciones} \\
  \hline
  ...
  \hline
  \multicolumn{3}{|c|}{\bfseries Mapeo geoespacial} \\
  \hline
